 ...
 ">
  ...
  <div id="posts" class="posts-expand">
    ...
    <c:forEach items="${contacts}" var="contact"> 
      <h1 ><a href="#" class="headerlink" >${contact.userContactTypeName }</a></h1>
      <p>
...
<script type="text/javascript"
    ...
    <script type="text/javascript">
      ...
      var disqus_identifier = 'works/index.html';
      var disqus_title = "works";
      var disqus_url = 'http://www.shuang0420.com/works/index.html';

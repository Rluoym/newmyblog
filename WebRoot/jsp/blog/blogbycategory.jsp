...
<body itemscope itemtype="//schema.org/WebPage" lang="en">
  ...
  <div class="custom-logo-site-title">
    <a href="${pageContext.request.contextPath }/UI/index"  class="brand" rel="start">
      <span class="logo-line-before"><i></i></span>
      <span class="site-title">博主</span>
    ...
    <c:forEach items="${listBlogAndCategory}" var="blogByCategory" varStatus="i">
		  <article class="post post-type-normal" itemscope itemtype="//schema.org/Article">
		    <header class="post-header">
		      ...
		      <h1 class="post-title">
		            <a class="post-title-link" href="${pageContext.request.contextPath}/UI/detail?blogId=${blogByCategory.blogId}" itemprop="url">

...
<title> 分类:${category.blogCategoryName} | 博主 </title><!-- hexo-inject:begin -->
</head>
...
<div class="site-nav-toggle">
  ...
  <section id="posts" class="posts-collapse">
    ...
    <c:forEach items="${listBlogAndCategory}" var="blogByCategory" varStatus="i">
		  <article class="post post-type-normal" itemscope itemtype="//schema.org/Article">
		    <header class="post-header">
		
		      <h1 class="post-title">
		            <a class="post-title-link" href="${pageContext.request.contextPath}/adminUI/updateBlog?blogId=${blogByCategory.blogId}" itemprop="url">
		                <span itemprop="name">${blogByCategory.blogTitle}</span> 
		            </a>
		            <a href="${pageContext.request.contextPath}/adminUI/updateBlog?blogId=${blogByCategory.blogId}"><input type="button" value="修改"/> </a>
		      </h1>
		      <div class="post-meta">
		        <time class="post-time" itemprop="dateCreated"
		              datetime="2016-12-27T09:55:12+08:00"
		              content="2016-12-27" >
		          ${i.count }
		        </time>
		      </div>
...
<script type="text/javascript">
  ...
  <script type="text/javascript"
    ...
    <script type="text/javascript">
      ...
      var disqus_identifier = 'categories/Data-Structure/index.html';
      var disqus_title = "";
      var disqus_url = '';

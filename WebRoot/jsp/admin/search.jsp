...
<link rel="stylesheet" href="http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
  ...
  <body>
    <form action="${pageContext.request.contextPath }/blog/serachBlog.action " method="post" target="body" id="searchForm">
    	            
				    <div class="col-md-4 ">
				        <div class="b-form-row b-input-search">
				            <input class="form-control" type="text" placeholder="搜索博客" name="keyWords"/>

			...
			<div class="content-wrap">
				...
				<div id="content" class="content">
					<div id="posts" class="posts-expand">
						...
						<h1 id="About-Me">
							<a href="" class="headerlink" ></a>添加联系方式
							<hr/>
						</h1> 
						<form action="${pageContext.request.contextPath }/user/addUserContact" method="post" >
							<input type="text" name="userContactTypeName" placeholder="联系类型"/><b> ：</b>
							<input type="text" name="userContact" placeholder="联系方式"/>
